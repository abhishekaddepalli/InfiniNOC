<template>
    <transition name="slide-fade" appear>
        ...
        <div v-else class="shadow-box big-padding text-center my-4">
            <h2 class="text-danger fw-bold mb-3">
                <font-awesome-icon icon="exclamation-circle" class="me-2" />
                {{ $t("Monitor Not Found") }}
            </h2>
            <p class="text-secondary mb-4">
                {{ $t("The requested monitor does not exist or you do not have permission to view it in the current organization.") }}
            </p>
            <router-link to="/dashboard" class="btn btn-primary fw-bold">
