        ...
        <div class="form">
            <form @submit.prevent="submit">
                <div>
                    ...
                    <div style="font-size: 28px; font-weight: bold; margin-top: 5px; color: #ff9933;">{{ productConfig.productName }}</div>
                    <p class="text-secondary small mb-1">{{ productConfig.tagline }}</p>
                    <div class="badge bg-secondary mb-3">by {{ productConfig.companyName }}</div>
                </div>
