            ...
            return {
                ...
                scales: {
                    x: {
                        ...
                        ticks: {
                            ...
                            autoSkipPadding: 30,
                            padding: 3,
                            color: this.$root.isDark ? "#94a3b8" : "#475569",
                        },
                        grid: {
                            color: this.$root.isDark ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.08)",
                            offset: false,
                        },
                    },
                    y: {
                        title: {
                            ...
                            color: this.$root.isDark ? "#cbd5e1" : "#1e293b",
                        },
                        ticks: {
                            color: this.$root.isDark ? "#94a3b8" : "#475569",
                        },
                ...
                plugins: {
                    tooltip: {
                        ...
                        intersect: false,
                        padding: 10,
                        backgroundColor: this.$root.isDark ? "#1e293b" : "#ffffff",
                        bodyColor: this.$root.isDark ? "#f8fafc" : "#0f172a",
                        titleColor: this.$root.isDark ? "#f8fafc" : "#0f172a",
                        borderColor: this.$root.isDark ? "#334155" : "#e2e8f0",
                        borderWidth: 1,
