...
/**
 * Check if an incident status is active
 * Active statuses: OPEN, ACKNOWLEDGED, IN_PROGRESS, MONITORING
...
export function isIncidentActive(status: string): boolean {
    ...
    return ["OPEN", "ACKNOWLEDGED", "IN_PROGRESS", "MONITORING"].includes(s);
}
