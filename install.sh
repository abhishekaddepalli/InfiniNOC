...
echo -e "🏛️ Super Admin Portal URL:  ${CYAN}http://${SERVER_IP}:${PORT}/super-admin${NC}"
echo ""
echo -e "📌 Important Setup Steps:"
echo -e "   1. Open ${CYAN}http://${SERVER_IP}:${PORT}${NC} in your web browser."
echo -e "   2. Create your initial admin account. (Account #1 automatically becomes Super Admin)."
echo -e "   3. Access the Super Admin Panel at ${CYAN}http://${SERVER_IP}:${PORT}/super-admin${NC} to configure SaaS plans and Razorpay."
echo ""
